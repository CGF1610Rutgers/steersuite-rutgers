...
ifeq ($(config),debug)
  ...
  ALL_LDFLAGS   += $(LDFLAGS) -L. -dynamiclib -stdlib=libc++ -Wl,-rpath,/Users/Arthi/Desktop/SteerSuite-Full/steersuite-rutgers/build/lib -install_name @rpath/libutil.dylib
  LDDEPS    +=
